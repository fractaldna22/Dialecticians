...
export class AudioStreamer {
  ...
  stop() {
    ...
    // Force hard disconnect for immediate silence
    ...
    // Create fresh node for next time
    this.gainNode = this.context.createGain();
    this.gainNode.connect(this.context.destination);
  }
  ...
  complete() {
    this.isStreamComplete = true;
    // If there is nothing in the queue and no source currently scheduled to be the end,
    // we should trigger complete immediately to avoid hanging state.
